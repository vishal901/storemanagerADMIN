 ...
 */
public class SpinnerFindusAdapter extends BaseAdapter {

    private Context context;
    private static LayoutInflater inflater;
    private List<findus> results;

    public SpinnerFindusAdapter(Context context, ArrayList<findus> results) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        findus setbranch = results.get(position);

        mItemHolder.textOne.setText(setbranch.getTitle());
     //  mItemHolder.idtext.setText(setbranch.getId());
